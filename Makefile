...
bin-tree =    BinTree/Cpp/BinTreeDump.cpp    BinTree/Cpp/BinTreeFunc.cpp 	BinTree/Cpp/BinTreeDiff.cpp   BinTree/Cpp/BinTreeCalc.cpp

name-table =  NameTable/NameTableFunc.cpp

common = 	  Common/Support.cpp

parser = 	  Parser/ParserGram.cpp

lib = 		  LIB/DIFF-Func.cpp

# Компиляция akin
diff:
	g++ $(bin-tree) $(name-table) $(common) $(lib) $(parser) main.cpp $(flags) -o diff.exe
