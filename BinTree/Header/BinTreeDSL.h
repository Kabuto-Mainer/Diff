...
#define COMPND_(f) ( createComplex (f, old_node, new_parent, table_var, name_var) )
// --------------------------------------------------------------------------------------------------
...
#define LN_(r) ( createOperNodeBin (NUM_(M_E), r, new_parent, LN_OPER) )
// --------------------------------------------------------------------------------------------------
...
#define NUM_(value) ( createNumNode (new_parent, value) )
